...
def run_intraday_backtest():
    ...
    preds_file = os.path.join(base_path, 'data', 'predictions_intraday', f'predictions_intraday_day2_{args.city}.csv')
    ...
    if not os.path.exists(preds_file) or not os.path.exists(market_file):
        print("Brak wymaganych plików dla Intraday Day 2. Uruchom export day 2 i skrypt fetch_intraday.")
        return
