...
def run():
    ...
    # Przewidujemy Day 1 Ahead dla runów 0000 i 1200
    df_0000 = get_predictions(city, base_path, 'day1_0000', use_f)
    df_1200 = get_predictions(city, base_path, 'day1_1200', use_f)
    ...
    out_path_csv = os.path.join(data_dir, f'predictions_intraday_{city}.csv')
